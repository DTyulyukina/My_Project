(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('ng2-daterangepicker'), require('moment'), require('ngx-treeview'), require('@angular/common'), require('@ngx-translate/core'), require('angular-2-dropdown-multiselect')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', 'ng2-daterangepicker', 'moment', 'ngx-treeview', '@angular/common', '@ngx-translate/core', 'angular-2-dropdown-multiselect'], factory) :
	(factory((global['angular-forms-utils'] = {}),global.ng.core,global.ng.forms,global.ng2Daterangepicker,global.moment_,global.ngxTreeview,global.ng.common,global.core$1,global.angular2DropdownMultiselect));
}(this, (function (exports,core,forms,ng2Daterangepicker,moment_,ngxTreeview,common,core$1,angular2DropdownMultiselect) { 'use strict';
...
var ReactiveFormComponent = /** @class */ (function () {
    function ReactiveFormComponent() {
        this.fields = [];
        this.events = [];
        this.afterInit = new core.EventEmitter(true);
        this.afterViewInit = new core.EventEmitter(true);
    }
    /**
     * @return {?}
     */
...
ReactiveFormComponent.propDecorators = {
    ...
    "afterViewInit": [{ type: core.Output },],
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
var FormField = /** @class */ (function () {
    ...
    FormField.prototype.required = function () {
        this.control.setValidators(/** @type {?} */ (forms.Validators.required));
        return this;
    };
    /**
     * @param {?} v
...
DatetimePickerComponent.propDecorators = {
    ...
    "datepickerComponent": [{ type: core.ViewChild, args: [ng2Daterangepicker.DaterangePickerComponent,] },],
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
var InputFloatComponent = /** @class */ (function () {
    ...
    InputFloatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.field.addValidator(forms.Validators.pattern(/^[+-]?([0-9]*[.])?[0-9]+$/));
...
var TreeViewComponent = /** @class */ (function () {
    function TreeViewComponent() {
        this.selectConfig = ngxTreeview.TreeviewConfig.create({
            hasAllCheckBox: true,
            hasFilter: true,
    ...
    TreeViewComponent.prototype.updateModel = function (values) {
        ...
        if (this.treeviewComponent) {
            try {
                for (var _a = __values(this.treeviewComponent.items), _b = _a.next(); !_b.done; _b = _a.next()) {
                    var item = _b.value;
...
TreeViewComponent.propDecorators = {
    ...
    "field": [{ type: core.Input },],
    "request": [{ type: core.Input },],
    "treeviewComponent": [{ type: core.ViewChild, args: [ngxTreeview.TreeviewComponent,] },],
};
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
AngularFormsUtilsConfigs.ctorParameters = function () { return [
    { type: ng2Daterangepicker.DaterangepickerConfig, },
]; };
/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
...
AngularFormsUtilsModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [
                    ...
                    angular2DropdownMultiselect.MultiselectDropdownModule,
                    forms.FormsModule,
                    ngxTreeview.TreeviewModule,
                    ng2Daterangepicker.Daterangepicker
                ],
                declarations: decExp,
                exports: decExp,
...
exports.AngularFormsUtilsConfigs = AngularFormsUtilsConfigs;
exports.AngularFormsUtilsModule = AngularFormsUtilsModule;
exports.FormField = FormField;
exports.ɵo = BusyButtonComponent;
exports.ɵk = DatePickerComponent;
exports.ɵu = DateRangePickerComponent;
exports.ɵb = DatetimePickerComponent;
exports.ɵl = DaysOfWeekComponent;
exports.ɵe = EnumselectComponent;
exports.ɵj = GroupSelectComponent;
exports.ɵg = InputFloatComponent;
exports.ɵf = InputTextComponent;
exports.ɵm = MultiSelectComponent;
exports.ɵc = MultiSelectCBComponent;
exports.ɵa = ReactiveFormComponent;
exports.ɵt = SelectTComponent;
exports.ɵd = SelectComponent;
exports.ɵi = SwitchComponent;
exports.ɵn = TextAreaComponent;
exports.ɵh = TimePickerComponent;
exports.ɵs = TreeViewItemComponent;
exports.ɵr = TreeViewRadioComponent;
exports.ɵq = TreeViewTxtComponent;
exports.ɵp = TreeViewComponent;
